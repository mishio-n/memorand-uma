          ...
          <Flex mb={2} width="100%">
            <Flex>
              <MarkCardContainer
                ...
                bg="markCard.blue.container.bg"
              >
                <MarkCardLabel bg="markCard.blue.label">1頭目</MarkCardLabel>
                <Box>
                  <Grid
              ...
              <MarkCardContainer
                ...
                bg={
                  betType === 'WIN' || betType === 'PLACE'
                    ? 'gray.400'
                    : 'markCard.blue.container.bg'
                }
              >
                <MarkCardLabel bg="markCard.blue.label">2頭目</MarkCardLabel>
                <Box>
                  <Grid
                    templateColumns="repeat(9, 20px)"
                    templateRows="repeat(2, 1fr)"
            ...
            <Flex>
              ...
              >
                <MarkCardLabel bg="markCard.blue.label">3頭目</MarkCardLabel>
                <Box>
                  <Grid
                    templateColumns="repeat(9, 20px)"
                    templateRows="repeat(2, 1fr)"
